...
class PedagogicStorage:
    """Encapsule l'acces a MinIO/S3 pour les ressources pedagogiques (documents, videos)."""
...
def get_storage() -> PedagogicStorage:
    return PedagogicStorage(
