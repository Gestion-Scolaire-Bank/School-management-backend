...
class AdminServiceClient:
    ...
    matiere, affectation enseignant) avant d'accepter une note - remplace la confiance
    aveugle accordee jusqu'ici a class_id/subject en texte libre (cf. proposition de
    schema - coherence inter-services)."""
